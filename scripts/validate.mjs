...
if(!Array.isArray(generalDomains)||generalDomains.length!==10) errors.push('general taxonomy: expected 10 domains')
...
if(generalLatest.taxonomyDomains!==10) errors.push('general coverage metrics: taxonomy domain count mismatch')
